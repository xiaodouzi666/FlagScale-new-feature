...
class PerformanceMonitor:
    ...
    def log_metrics(self, iteration: int, writer=None, wandb_writer=None):
        ...
        if writer is not None:
            ...
            writer.add_scalar('performance/avg_step_time_ms', metrics.avg_step_time * 1000, iteration)
            writer.add_scalar('performance/samples_per_second', metrics.samples_per_second, iteration)
