...
class FLOPSFormulas:
    ...
    def attention_flops(
        ...
        attention_score_flops = 2 * batch_size * num_attention_heads * seq_length * seq_length * head_dim

        # Attention output (scores @ V)
        attention_output_flops = 2 * batch_size * num_attention_heads * seq_length * seq_length * head_dim
    ...
    def gqa_attention_flops(
        ...
        total_flops = q_flops + kv_flops + attention_score_flops + attention_output_flops + output_proj_flops
    ...
    def moe_flops(
        ...
        if use_swiglu:
            ...
            expert_flops = (
                2 * 2 * active_tokens * hidden_size * ffn_hidden_size
            ) / num_experts
    ...
    @staticmethod
    def gradient_accumulation_factor(
